...
public class DrogaAZ1 {
    ...
    static void droga() {
        ...
        for (int i = 0; i < miasta.length; i++) {
            ...
            System.out.println(miasta[i] + " ma " + pol + " polonczenia");
        }
        ...
        int optymalneOdwiedzanie = 0;
        int kilometry = 0;

        while (optymalneOdwiedzanie < 8) {
            int lindex = 0;
